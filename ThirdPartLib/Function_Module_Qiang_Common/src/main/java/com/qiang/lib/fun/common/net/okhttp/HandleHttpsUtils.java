...
import com.qiang.lib.fun.common.utils.CloseUtils;
 ...
 *      FunctionName    ： HandleHttpsUtils
 *      Deprecation     ： Https证书校验工具类
 * </pre>
 */

public class HandleHttpsUtils {
    ...
    /**
     * 主机名校验方法，请把”192.168.1.1”换成公司的主机IP：
     */
    public static HostnameVerifier getHostnameVerifier() {
        return new HostnameVerifier() {
            @Override
            public boolean verify(String hostname, SSLSession session) {
                if ("192.168.1.1".equals(hostname)) {
                    return true;
                } else {
