package com.qiang.lib.fun.common.widget.dialog.alertview;
 ...
 *      ModuleName      ：
 *      FunctionName    ：
 *      Deprecation     ： 精仿iOS AlertViewController控件Demo
 * </pre>
 */

@Route(path = "/common/dialog")
public class MainActivityDialog extends Activity implements OnItemClickListener, OnDismissListener {
    ...
    public void customShow(View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        View inflate = View.inflate(this, R.layout.activity_main_dialog, null);
