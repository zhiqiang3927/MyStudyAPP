package com.qiang.lib.fun.frame.setting.GestureLock.lib;
...
public class GestureLockView extends View {
    ...
    //以下9种颜色均对外提供设置颜色的方法
    private int OUT_CYCLE_NORMAL_COLOR = getResources().getColor(R.color.function_common_gesture_color_deep_gray); // 外圆正常颜色
    private int OUT_CYCLE_CHOOSE_COLOR = getResources().getColor(R.color.function_common_gesture_color_deep_bule);// 外圆选中颜色

    private int INNER_CYCLE_NORMAL_COLOR = getResources().getColor(R.color.function_common_gesture_color_normal_gray); // 内圆正常颜色
    private int INNER_CYCLE_CHOOSE_COLOR = getResources().getColor(R.color.function_common_gesture_color_litle_blue); // 内圆选中颜色
    private int INNER_CYCLE_ERROR_COLOR = getResources().getColor(R.color.function_common_gesture_color_red); // 连接错误时内圆颜色

    private int LINE_NORMAL_COLOR = getResources().getColor(R.color.function_common_gesture_color_ablue); // 连接线颜色
    private int LINE_ERROR_COLOR = getResources().getColor(R.color.function_common_gesture_color_ared); // 连接错误醒目提示颜色


    private int INNER_CYCLE_DIY_COLOR = getResources().getColor(R.color.function_common_gesture_color_ok_green); // 自定义 释放后内圆的颜色
    private int LINE_DIY_COLOR = getResources().getColor(R.color.function_common_gesture_color_agreen); //  自定义 释放后外圆和连线的颜色
